...
import {Text, View, Button, Image, StyleSheet, ScrollView, Alert, Dimensions} from 'react-native';
...
_cancelworkout=()=>{
  ...
  [
    ...
    {text: 'Yes', onPress: () => this.props.navigation.navigate('ViewWorkout')},
  ],
  {cancelable: false},
);
}
        ...
        <View>
          ...
          <View style={{flexDirection: 'row', flexWrap: 'wrap',flex:1}}>
            <View style={{flexDirection: 'row', flexWrap: 'wrap',flex:1}}>
              ...
              <Text style={styles.exercise}>{this.state.reps} </Text>
            </View>
            <View>
              <Button onPress={this._cancelworkout} title="Cancel"/>
            </View>
          </View>
        </View>
